package com.tma.training.demo12_virtual_thread.demo05.externalservice;
...
public class Client {
    ...
    private static final String PRODUCT_REQUEST_FORMAT = "http://localhost:8082/restaurant/product/%d";
    private static final String RATING_REQUEST_FORMAT = "http://localhost:8082/restaurant/product/%d/rating";
